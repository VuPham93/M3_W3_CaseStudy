...
<div class="mx-lg-5 px-lg-4 mt-5 py-2">
    <p class="display-4">Top Sellers</p>
                    ...
                    <a href="gamesServlet?action=detail&id=${game.id}">
                        ...
                        <div class="card-body bg-primary text-white">
                            ...
                            <table class="card-body text-white">
                                <tr>
                                    <td style="width: 100px" rowspan="2"><button type="button" class="btn btn-outline-warning" disabled style="width: 80px; height: 40px">-${game.discount}%</button></td>
                                    <td>
